  ...
  return (
    <PageTemplate 
      ...
      <Helmet>
        ...
        <meta name="description" content="가상화폐 / 암호화폐 모의 거래소 KAISER (KAISER), 과연 당신은 가상화폐 시장에서 수익을 낼 수 있을까요? 모의거래를 통해 알아보세요."/>
      </Helmet>
      ...
      <div className={cx('block', 'responsive')}>
        <h2>KAISER에선, 현재 총 <b>69</b>개의 가상화폐를 지원합니다.</h2>
        <CoinMainContainer/>
      ...
      <div className={cx('third')}>
        <div className={cx('responsive', 'grid')}>
          ...
          <a className={cx('column')} href="https://github.com/velopert/bitimulate" target="_blank" rel="noopener noreferrer">
            ...
            <div className={cx('description')}>
              <h3>오픈소스</h3>
              <p>Kaiser 오픈소스 프로젝트 입니다. <br/>Pull Request는 언제나 환영입니다.</p>
            </div>
          </a>
        </div>
        <div className={cx('my-message', 'responsive')}>
          <div>
          <p class="title">DECENTRALIZED EXCHANGE</p>
                Fast and Secure transaction matching
                based on Aiser block-chain technology
      ...
      <div className={cx('footer')}>
        <div className={cx('email')}>
          <EmailIcon/> support@KAISER.com
        </div>
        <div className={cx('copyright')}>
          Copyright © 2017 KAISER
        </div>
        <div className={cx('copyright')}>
